...
public final class _10Country_002dSpecial_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t<title>Peri Peri, Country Special</title>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<img class=\"img-responsive\" src=\"img/e10.jpg\" height=\"600\" width=\"1100\">\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"entry-main\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"entry-header\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<h2 class=\"entry-title ui-title-inner\">For all those with a partiality for veggies, this one's loaded - crunchy onions, crisp capsicum, Spinach and fresh juicy tomatoes. Yum!</h2>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"pizza-builder__radio-title\">Medium<br>Rs. 390</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"pizza-builder__radio-title\">Large<br>Rs. 510</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-md-6\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<p>Bell Pepper, Spinach & Ricotta base, garnished with Hollandaise & Lemon, served with Cracked Pepper & Sea Salt.</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t    </div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\n");
