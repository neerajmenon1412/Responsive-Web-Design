...
<head>
		...
		<title>Peri Peri, Country Special</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e10.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">For all those with a partiality for veggies, this one's loaded - crunchy onions, crisp capsicum, Spinach and fresh juicy tomatoes. Yum!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_9">
															...
															<span class="pizza-builder__radio-title">Small<br>Rs. 230</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 390</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_18">
															...
															<span class="pizza-builder__radio-title">Large<br>Rs. 510</span>
														</label>
											</div>
											<div class="col-md-6">
											<div>
											...
											<p>Bell Pepper, Spinach & Ricotta base, garnished with Hollandaise & Lemon, served with Cracked Pepper & Sea Salt.</p>
										    </div>
											</div>
											</div>
