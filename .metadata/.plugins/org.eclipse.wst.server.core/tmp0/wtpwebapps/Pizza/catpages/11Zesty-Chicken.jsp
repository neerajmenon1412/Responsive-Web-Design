...
<head>
		...
		<title>Peri Peri, Zesty Chicken</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e11.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">If you're looking for a pizza that has a lot of flavor and is a little different from the rest, then Zesty Chicken is the way to go with the marinated chicken, sundried tomatoes and roasted capsicum garnished with fresh herbs and lemon!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_9">
															...
															<span class="pizza-builder__radio-title">Small<br>Rs. 280</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 440</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_18">
															...
															<span class="pizza-builder__radio-title">Large<br>Rs. 580</span>
														</label>
											</div>
											<div class="col-md-6">
											<div>
											...
											<p>Marinated Chicken, Sundried Tomatoes, Roasted Capsicum & Feta on a Tomato base, garnished with Fresh Herbs & Lemon.</p>
										    </div>
											</div>
											</div>
