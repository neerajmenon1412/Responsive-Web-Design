...
<head>
		...
		<title>Peri Peri, Veg Primavera</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e13.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">This flavorful and popular pizza is topped with Spinach, Paneer, cherry tomatoes and spanish onions. You can't miss this one if you are a veg lover!.</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 420</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_18">
															...
															<span class="pizza-builder__radio-title">Large<br>Rs. 570</span>
														</label>
											</div>
											<div class="col-md-6">
											<div>
											...
											<p>Spinach & Ricotta, Paneer, Black Olives, Spanish Onions, Cherry Tomatoes & Feta served with Cracked Pepper & Sea Salt.</p>
										    </div>
											</div>
											</div>
