...
<head>
		...
		<title>Peri Peri, Peri-Peri Chicken</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e2.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">Boneless skinless chicken breasts pounded to a uniform thickness with Peri Peri Hot Marinade to give your taste buds a treat!</h2>
										</div>
									</div>
								</article><!-- end post -->
