...
<head>
		...
		<title>Peri Peri, Chicken Bonanza</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e3.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">A rich chicken topping experience with marinated chicken in moorish spices thus justifying the name Bonanza!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 430</span>
														</label>
											...
											<p>Chicken marinated in Moorish spices, Tomatoes, Capsicum Medley, topped with a Slice of Lemon & Yoghurt sauce.</p>
										    </div>
											</div>
											</div>
