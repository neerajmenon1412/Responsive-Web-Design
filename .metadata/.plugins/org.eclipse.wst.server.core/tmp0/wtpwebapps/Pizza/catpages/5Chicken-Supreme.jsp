...
<head>
		...
		<title>Peri Peri, Chicken Supreme</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e5.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">A really Supreme experience with slow cooked chicken on a tomato base garnished with Avacado, coriander,lime and topped with mayo!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_9">
															...
															<span class="pizza-builder__radio-title">Small<br>Rs. 290</span>
														</label>
											...
											<p>Slow Cooked Pulled Chicken, Red Capsicum on a Tomato base, Garnished with Avocado, Coriander & Lime, topped with mayo.</p>
										    </div>
											</div>
											</div>
