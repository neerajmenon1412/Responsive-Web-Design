...
<head>
		...
		<title>Peri Peri, Exotic Mushroom</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e6.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">Pizza Description...Piled high with porcini and a blend of exotic mushrooms, Exotic Mushroom Pizza is the perfect delivery for mushroom lovers!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_9">
															...
															<span class="pizza-builder__radio-title">Small<br>Rs. 260</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 380</span>
														</label>
											...
											<p>Garlic Cloves, Red Pepper Flakes, , Crushed Tomatoes, , Mozzarella, Oyster Mushrooms, Caramelised Onions & Toasted Pine Nuts.</p>
										    </div>
											</div>
											</div>
