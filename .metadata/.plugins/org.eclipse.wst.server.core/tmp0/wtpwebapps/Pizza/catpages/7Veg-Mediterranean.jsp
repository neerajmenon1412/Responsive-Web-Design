...
<head>
		...
		<title>Peri Peri, Veg Mediterranean</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e7.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">For all the veggie lovers, Veg Mediterranean is the perfect pizza to go for with all the tomato and onions infused on a garlic infused base!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
											...
											<p>Tomatoes, Green Capsicum, Spanish Onions, Feta & Oregano on a Garlic infused base, garnished with Mint Yoghurt & Lemon.</p>
										    </div>
											</div>
											</div>
