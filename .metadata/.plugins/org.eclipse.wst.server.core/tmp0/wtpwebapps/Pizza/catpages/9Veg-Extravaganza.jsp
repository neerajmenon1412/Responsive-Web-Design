...
<head>
		...
		<title>Peri Peri, Veg Extravaganza</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e9.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">A pizza that decidedly staggers under an overload of golden corn, jalapenos, crunchy onions, roasted capsicum, juicyfresh tomatoes with extra cheese to go all around!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
											...
											<p>Spanish Onions, Roasted Capsicum, Jalapeños & Chilli on a Spicy Tomato Salsa base, served with Fresh Avocado Salsa.</p>
										    </div>
											</div>
											</div>
