...
<head>
		...
		<title>Peri Peri, Chicken Mediterranean</title>
							...
							<div class="row">
								<div class="col-xs-545">
									<div class="section__inner">
										<h1 class="ui-title-page">Chicken Mediterranean</h1>
										<ol class="breadcrumb">
											<li><a href="http://localhost:8080/Pizza/">Home</a></li>
											<li><a href="../shop-catalog.jsp">Pizza Menu</a></li>
											<li class="active">Chicken Mediterranean</li>
										</ol>
									</div>
									<!-- end section__inner -->
								</div>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e12.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">Try this delicious full flavored Mediterranean Chicken Pizza Recipe that is sure to be a family favorite with all the Tomatoes, green capsicum, feta on the slow cooked marinated chicken infused on a garlic base!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 410</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_18">
															...
															<span class="pizza-builder__radio-title">Large<br>Rs. 520</span>
														</label>
											</div>
											<div class="col-md-6">
											<div>
											...
											<p>Slow Cooked Marinated Chicken, Tomatoes, Green Capsicum, Spanish Onions, Feta & Oregano on a Garlic infused base, garnished with Mint Yoghurt & Lemon.</p>
										    </div>
											</div>
											</div>
