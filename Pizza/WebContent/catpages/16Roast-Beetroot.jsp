...
<head>
		...
		<title>Peri Peri, Roast Beetroot</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e16.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">This pizza features slowcooked Roasted Beetroot along with baby spinach and bocconicini topped with crushed walnuts and honey!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_9">
															...
															<span class="pizza-builder__radio-title">Small<br>Rs. 250</span>
														</label>
											...
											<p>Slowcooked Roasted Beetroot, Baby Spinach, Bocconcini topped with Crushed Walnuts and Honey.</p>
										    </div>
											</div>
											</div>
