...
<head>
		...
		<title>Peri Peri, Meat Deluxe</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e4.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">Oven baked chicjen breasts along with roasted capsicum, jalapenos and chilly!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
											...
											<p>Spanish Onions, Roasted Capsicum, Jalapenos & Chilli on a Spicy Tomato Salsa base, served with Fresh Avocado Salsa.</p>
										    </div>
											</div>
											</div>
