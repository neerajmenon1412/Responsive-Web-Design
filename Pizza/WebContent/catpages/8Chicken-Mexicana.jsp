...
<head>
		...
		<title>Peri Peri, Chicken Mexicana</title>
							...
							<div class="col-xs-12">
								<article class="post post_first text-center clearfix">
									<div class="entry-media">			
											<img class="img-responsive" src="img/e8.jpg" height="600" width="1100">							
									</div>
									
									
									<div class="entry-main">
										<div class="entry-header">
											<h2 class="entry-title ui-title-inner">The taste bud-tingling delight of hot and spicy chicken topped with spanish onions,juicy tomato,sizzling red pepper, fresh capsicum and a sprinkling of exotic Mexican herb!</h2>
										</div>
									</div>
								</article><!-- end post -->
								...
								<article class="post post_mod-b clearfix">
												...
												<div>
													<h3 class="panel-title"><span class="panel-title__number"></span>Different Crust's Size</h3><br><br>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_9">
															...
															<span class="pizza-builder__radio-title">Small<br>Rs. 270</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_14">
															...
															<span class="pizza-builder__radio-title">Medium<br>Rs. 350</span>
														</label>
														...
														<label class="pizza-builder__radio-label" for="pizza-size_18">
															...
															<span class="pizza-builder__radio-title">Large<br>Rs. 560</span>
														</label>
											</div>
											<div class="col-md-6">
											<div>
											...
											<p>Pepperoni, Spanish Onions, Fresh Capsicum, Marinated Chicken , Olive Tapenade & Garlic on a Tomato base.</p>
										    </div>
											</div>
											</div>
